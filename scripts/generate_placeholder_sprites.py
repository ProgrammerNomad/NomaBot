...
SPRITES = ROOT / "assets" / "characters" / "nomabot" / "sprites" / "body"
...
def main() -> None:
    make_sprite("idle_01", (67, 97, 238))
    make_sprite("idle_02", (76, 201, 240))
    make_sprite("coding_01", (247, 37, 133))
    make_sprite("coding_02", (181, 23, 158))
